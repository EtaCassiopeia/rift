...
pub struct Theme {
    ...
    pub disabled: Color,
    pub focus: Color,
    // Command bar colors (nvim-style)
    pub key_fg: Color, // Accent color for [key] brackets
    pub cmd_fg: Color, // Muted color for labels
}
    ...
    pub fn from_preset(preset: ThemePreset) -> Self {
        match preset {
            ...
            ThemePreset::Dark => Self {
                ...
                key_fg: Color::Rgb(130, 170, 220), // Soft blue accent
                cmd_fg: Color::Rgb(120, 120, 120),
            },
            ThemePreset::Light => Self {
                ...
                key_fg: Color::Rgb(65, 105, 225), // Royal blue accent
                cmd_fg: Color::Rgb(180, 180, 180),
            },
            ThemePreset::Nord => Self {
                ...
                key_fg: Color::Rgb(136, 192, 208), // nord8 (frost cyan)
                cmd_fg: Color::Rgb(76, 86, 106),   // nord3
            },
            ThemePreset::Dracula => Self {
                ...
                key_fg: Color::Rgb(139, 233, 253), // cyan
                cmd_fg: Color::Rgb(98, 114, 164),  // comment
            },
        }
    }
